...
}[] = [
  {
    ...
    projects: [
      ...
      },
      {
        ...
        description: "Real-time visibility into transaction health, anomaly detection, and retry management.",
        image: "dipay-reconciliation-table.png",
        color: "bg-indigo-50",
        tags: ["Real Project", "Dashboard"],
      },
    ],
  },
  {
