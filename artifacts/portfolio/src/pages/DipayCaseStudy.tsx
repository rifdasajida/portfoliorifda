        ...
        <div className="max-w-[760px] mx-auto px-7">
          ...
          >
            ...
            <p className="text-lg text-[#4A5568] max-w-[620px] mb-10 leading-[1.55]">
              ...
              settlement cycle through automated reconciliation.
            </p>
          </motion.div>
      ...
      <div className="py-[72px]">
        <div className="max-w-[760px] mx-auto px-7 space-y-16">
          ...
          <Reveal>
            ...
            <p className="text-[#4A5568] leading-[1.7] mb-4">
              Rather than immediately redesigning the dashboard, I worked with Finance and Operations
              teams to understand how settlement decisions were actually made.
            </p>
